...
public class BookIntegrationTest {
    ...
    // authenticated version for POST/PUT/DELETE
    TestRestTemplate authTemplate;
    ...
    @BeforeEach
    void setUp() {
        authTemplate = restTemplate.withBasicAuth("user", "password123");
    ...
    void testCreateAndGetBook() {
        ...
        ResponseEntity<BookResponseDTO> createResponse = authTemplate.postForEntity(
    ...
    void testGetAllBooks() {
        authTemplate.postForEntity("/api/books", new BookRequestDTO("Book One", orwellId, 2020, "978-1111111111"), BookResponseDTO.class);
        authTemplate.postForEntity("/api/books", new BookRequestDTO("Book Two", orwellId, 2021, "978-2222222222"), BookResponseDTO.class);
        authTemplate.postForEntity("/api/books", new BookRequestDTO("Book Three", orwellId, 2022, "978-3333333333"), BookResponseDTO.class);
    ...
    void testUpdateBook() {
        ...
        ResponseEntity<BookResponseDTO> updateResponse = authTemplate.exchange(
                "/api/books/" + id,
                HttpMethod.PUT,
